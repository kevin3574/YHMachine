package kzy.com.gyyengineer.constant;
...
import kzy.com.gyyengineer.utils.ImgHandler;
...
//				imageView, options_circle, animateFirstDisplayListener);
		...
		imageView.setImageDrawable(ImgHandler.ToCircularBig(R.mipmap.home_114));
		Bitmap bitmap = null;
	...
	public static void initImageLoader() {
		...
		options_circle = new DisplayImageOptions.Builder()
				.showImageOnLoading(
						ImgHandler.ToCircularBig(R.mipmap.home_114))
